...
def get_code_mask(code, token_pos, last_idx, max_source_length, eos_position):
    tree = parser.parse(bytes(code, "utf8"))
    root_node = tree.root_node
    ...
    mask = create_mask(code, token_pos, result, max_source_length, last_idx, eos_position, statement_result, df_path)
    return mask
